...
public class DirtTest {
	...
	public static void main(String[] args) throws IOException {
		...
		DirtWordService dirtWordService = new DirtWordService(getResource("resource/key.txt"));
		...
		DirtWordService dirtWordService2 = new DirtWordService(getResource("resource/Harmony.txt"));
